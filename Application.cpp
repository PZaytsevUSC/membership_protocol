...
int main(int argc, char *argv[]) {
    argc = 2;
    // argv = "testcases/singlefailure.conf";
	...
	Application *app = new Application("/Users/pzaytsev/Desktop/cloudcomputing/mp1/Membership Protocol/testcases/singlefailure.conf");
	// Call the run function
	app->run();
	// When done delete the application object
	delete(app);
//    Params * params = new Params();
//    params->setparams("/Users/pzaytsev/Desktop/cloudcomputing/mp1/testcases/singlefailure.conf");
//    delete params;
...
void Application::fail() {
	...
	if( par->SINGLE_FAILURE && par->getcurrtime() == 100 ) {
        // takes random node and remove it
